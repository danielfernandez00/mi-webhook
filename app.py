...
INTENT_INSTRUCTIONS = {
    "caracteristicas_tecnicas": "Responde de manera concisa sobre el DC-SUV 2025 usando la información disponible. Céntrate en las motorizaciones disponibles, sus ventajas y el precio de cada una. "
